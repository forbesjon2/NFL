...
class NFLUtils():
    ...
    def fbacktest_model_custom_loss(self, performance_tensor_x, perf_date_col, 
        ...
        for i in range(len(performance_tensor_x)):
            ...
            while len(current_day_bets) != 0:
                ...
                print(f"{current_date} - Pred: {winning_team} won against {losing_team}. Correct: {amt_after_bet > account_value} ")
...
# ----------------------------------------------------
    ...
    def getMLBOddsSharkData(self, isoDate):
        """
